...
func (c *warehouseServiceClient) CheckAndBlockStock(ctx context.Context, in *StockRequest, opts ...grpc.CallOption) (*StockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/warehouse.WarehouseService/CheckAndBlockStock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *warehouseServiceClient) UpdateStock(ctx context.Context, in *UpdateStockRequest, opts ...grpc.CallOption) (*StockResponse, error) {
	out := new(StockResponse)
	err := c.cc.Invoke(ctx, "/warehouse.WarehouseService/UpdateStock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WarehouseService_CheckAndBlockStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/warehouse.WarehouseService/CheckAndBlockStock",
	}
...
func _WarehouseService_UpdateStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/warehouse.WarehouseService/UpdateStock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var WarehouseService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "warehouse-service/api/warehouse.proto",
}
